...
namespace ZnakiLibrary
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="ZnakiZodiaka")]
    ...
    partial void InsertZnaki(Znaki instance);
    partial void UpdateZnaki(Znaki instance);
    partial void DeleteZnaki(Znaki instance);
    #endregion
		
		public LinqToDatabaseDataContext() : 
				base(global::ZnakiLibrary.Properties.Settings.Default.ZnakiZodiakaConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Znaki> Znakis
		{
			get
			{
				return this.GetTable<Znaki>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Znaki")]
	public partial class Znaki : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnimageChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_image", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		public string image
		{
			get
			{
